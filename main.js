...
class Instructions extends Phaser.Scene {
    ...
    {   
        ...
        if (whatgame == 'game'){
            this.add.text(100, 380, 'Ты должен управлять роботом и собирать звёздочки, ', { fontFamily: 'bebas', fontStyle: 'bold', fontSize: 20, color: '#000000' });
            this.add.text(100, 410, 'уворачиваясь и отстреливаясь от вражеских коптеров!', { fontFamily: 'bebas', fontStyle: 'bold', fontSize: 20, color: '#000000' });
...
class Game_Lvl_1 extends Phaser.Scene {
    ...
    {   
        ...
        heart_3 = hearts.create(130, 228, 'heart').setDepth(1);
